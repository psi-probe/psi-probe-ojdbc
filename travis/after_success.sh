...
if [ $TRAVIS_REPO_SLUG == "psi-probe/psi-probe-ojdbc" ] && [ $TRAVIS_PULL_REQUEST == "false" ] && [ $TRAVIS_BRANCH == "master" ] && [[ "$commit_message" != *"[maven-release-plugin]"* ]]; then
...
elif [ $TRAVIS_REPO_SLUG == "psi-probe/psi-probe-ojdbc" ] && [ $TRAVIS_PULL_REQUEST != "false" ]; then
